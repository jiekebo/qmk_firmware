...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_ansi(
	       KC_GRV,  KC_1,    KC_2, KC_3, KC_4, KC_5,   KC_6, KC_7, KC_8,    KC_9,   KC_0,             KC_MINS, KC_EQL,  KC_BSPC,  KC_NUM,  KC_EQL, KC_PSLS, KC_PAST,
	...
	[1] = LAYOUT_ansi(
	       KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4, KC_F5, KC_F6, KC_F7, KC_F8,   KC_F9,   KC_F10,   KC_F11, KC_F12, KC_DEL,   KC_NUM, KC_EQL, KC_PSLS, KC_PAST,
		   KC_TAB,  KC_HOME, KC_UP,   KC_PGUP, QK_BOOT, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SCRL, KC_PAUS, KC_UP, KC_INS, KC_ENT,     KC_P7,   KC_P8,  KC_P9,   KC_PMNS,
		   KC_LCAP, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT,                     KC_P4,   KC_P5,  KC_P6,   KC_PPLS,
